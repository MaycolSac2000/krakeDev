...
esProductoValido = function (nombreProducto) {
    ...
    let caracteresProducto = nombreProducto.length;
    if (caracteresProducto > 10) {
        mostrarTexto("lblError1", "*No puede tener mas de 10 caraceteres");
        sinErrores = false;
    }
...
esCantidadValida = function (cantidad) {
    ...
    if (cantidad < 0 || cantidad > 100) {
        ...
        mostrarTexto("lblError2", "*Deben ser numero entre 0 y 100");
        sinErrores = false;
...
esPrecioValido = function (precioProducto) {
    ...
    if (precioProducto < 0 || precioProducto > 50) {
        ...
        mostrarTexto("lblError3", "*Deben ser numero entre 0 y 50");
        sinErrores = false;
    }
